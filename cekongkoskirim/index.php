...
<html lang="en">
  ...
  <body>
    <div class="jumbotron cs-jumbotron">
      <div class="container">
      <center><h1>Cek Ongkos Kirim Yuk !!</h1>
      <p>Kirim Paket Se Indonesia</p></center>
      </div>
    </div>
    ...
    <div class="container konten1">
      ...
      <div class="row">
        ...
        <div class="col-md-2">
          ...
          <div id="pos_asal">
            <input type="text" class="form-control" name="pos_asal" readonly>
          </div>
        </div>          
        <!-- Akhir Data Asal -->
      ...
      <div class="row">
        ...
        <div class="col-md-3">
         ...
         <div class="col-md-2">
          <label>Kode Pos</label>
          <div id="pos_tujuan">
            <input type="text" class="form-control" name="pos_tujuan" readonly>
          </div>
        </div>           
        <div class="col-md-2">
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    $('#provinsiasal').change(function(){
      ...
      $.ajax({
              type : 'GET',
              url  : 'http://localhost/cekongkoskirim/rajaongkir/kabupaten_asal.php',
    ...
    $('#provinsitujuan').change(function(){
      ...
      $.ajax({
              type : 'GET',
              url  : 'http://localhost/cekongkoskirim/rajaongkir/kabupaten_tujuan.php',
...
// Kode
    $("#asal").change(function(){
      ...
      $.ajax({
              type : 'GET',
              url  : 'http://localhost/cekongkoskirim/rajaongkir/pos_asal.php',
    ...
    $("#tujuan").change(function(){
      ...
      $.ajax({
              type : 'GET',
              url  : 'http://localhost/cekongkoskirim/rajaongkir/pos_tujuan.php',
...
// akhir kode
    ...
    $("#cek").click(function(){
      ...
      $.ajax({
              type : 'POST',
              url : 'http://localhost/cekongkoskirim/RajaOngkir/cek_ongkir.php',
